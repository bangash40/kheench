...
android {
    ...
    // Release key lives in android/key.properties + app/kheench-release.jks
    // (both git-ignored). Without them, release builds fall back to the debug key.
    ...
    buildTypes {
        release {
            ...
            // The engine library breaks when its classes are shrunk away.
